...
| Targeted pytest | 통과 | `.\.venv\Scripts\python.exe -m pytest backend/tests/test_live_phase3_completion_audit.py backend/tests/test_live_canary_preflight.py backend/tests/test_kis_live_token_refresh_preflight_tool.py backend/tests/test_live_public_route_scaffold.py backend/tests/test_no_live_adapter.py -q -p no:cacheprovider --basetemp $env:TEMP\stock_live_authority_record_regression` -> `25 passed` |
