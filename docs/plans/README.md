...
| 최신 backend pytest | full backend `531 passed in 669.95s`, sync worker loop API `19 passed`, Settings sync preset focused `2 passed`, Telegram cancel/report command `17 passed`, bounded bot regression `7 passed`, KIS matrix docs suite 통과 |
