...
| 최신 backend pytest | full backend `531 passed in 775.81s`, sync worker loop API `19 passed`, Telegram cancel/report command `17 passed`, bounded bot regression `7 passed`, Settings preset focused suite, KIS matrix docs suite 통과 |
