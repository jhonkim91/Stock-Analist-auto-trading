...
| Latest backend pytest | Phase 5 sync/portfolio `6 passed`, no-live regression `5 passed`, KIS adapter `3 passed`; full backend `293 passed` |
| Latest Phase 5 sync pytest | `6 passed` |
