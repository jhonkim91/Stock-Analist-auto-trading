...
| 6. 자동매매 loop | 예정 | screener/watchlist 후보, stop-loss, trailing stop, MA cross 감시, 기본 OFF |
| 7. 운영 검증 | 예정 | backend pytest, secret scan, runbook, Telegram/KIS paper dry-run |
